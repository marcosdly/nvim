...
-- Window
set("n", "<leader>wn", "<cmd>wincmd w<cr>", { desc = "Window: Go to next (wrap around)" })
set("n", "<leader>wp", "<cmd>wincmd W<cr>", { desc = "Window: Go to previous (wrap around)" })
...
set("n", "<leader>wP", function() -- todo to preview window or error
  ...
  if not ok then
    vim.print("No preview window available.")
  end
end, { desc = "Window: Go to preview window" })
set("n", "<leader>wt", "<cmd>wincmd T<cr>", { desc = "Window: Move to new tab" })
set("n", "<leader>w=", "<cmd>wincmd =<cr>", { desc = "Window: Even out dimensions of all windows" })
...
set("n", "<leader>wf", "<cmd>wincmd _<cr><cmd>wincmd |<cr>", { desc = "Window: Maximum dimentions" })
